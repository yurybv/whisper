...
| WH-M2-003 | Implement mode transformation and dictation state machine | done | WH-M2-001..002 |
...
| WH-M2-007 | Review end-to-end dictation milestone | blocked | WH-M2-001..006, WH-M2-008 |
| WH-M2-008 | Harden dictation failure recovery and completion feedback | ready | WH-M2-001..006 |
