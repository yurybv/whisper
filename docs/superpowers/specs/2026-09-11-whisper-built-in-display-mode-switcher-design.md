...
- Command-Shift-K always presents the mode switcher on the Mac's built-in display.
...
- On the two-display Mac, put another application on the built-in display, press Command-Shift-K, verify the panel appears centered there, press Escape, and verify focus returns to that application.
